...
export function Pg5_MorroSP() {
  return (
    ...
    <Container>
        ...
        <h3>
            Morro de São Paulo, BA | 2022
        </h3>

        <p>
        Não tem como esquecer a pandemia, né! Eu precisava viajar depois de anos em casa. 
        Decidi viajar com minha mãe, dar de presente pra nós duas uma viagem pois merecíamos depois de passar por tudo isso. Decidimos ir para Porto de Galinhas. Porém, apesar de eu adorar viajar com minha mãe, eu estava precisando de uma viagem solo tbm. Quem já viaja sozinha vai me entender. Eis então que antes de viajar com mainha eu peguei cinco dias de férias e fui pra Morro de SP.
        Há anos que eu tinha vontade de conhecer Morro, ouvi falar de lá quando fiz minha primeira viagem sozinha para Itacaré, na Bahia tbm.       
        </p>
        <p>
        ...
        Mas a quarta praia é pura tranquilidade e cheia de piscinas naturais com muuitos peixinhos. Apaixonei nesse lugar.
        </p>
        <p>
        O centrinho de Morro fica na segunda praia e boa parte das hospedagens tbm. De onde eu estava até lá dava pra ir de boa andando durante o dia, na maré baixa. Mas à noite só conseguia ir com o transporte da pousada que é rústico mas gratuito, rs. De forma geral as pousadas das quarta e quinta praia oferecem esse transporte em horários específicos durante o dia e a noite. 
        </p>
        <p>
        Agora, bora de perrengue?! Primeira noite fui pro centrinho e comprei um crepe, caminhei um pouco enquanto comia e quando retornei pra comprar uma bebidinha, cadê meu celular??? “Ah, pronto, roubaram meu celular naquela muvuquinha, fodeu!!!”
        Retornei pro restaurante que era o ponto de encontro pro transporte e falei com uma funcionária. Ela ligou pro meu celular, chamava mas ninguém atendia. Ela disse que era muito raro ocorrerem roubos por lá, que eu deveria falar com a moça do crepe. 
        ...
        <ol>
            ...
            Em 2022 eu estava toda ryca, hahah. Janeiro fui sozinha pra Morro na minha pousada isolada; Fevereiro viajei com minha mãe pra Porto de Galinhas, lembrando que eu que convidei minha mãe, eu queria sim viajar com ela; em abril fui pra STL com uma colega e váaarios amigos dela, fomos de trip; agosto fiz a rota das emoções e fiz do meu jeitinho as hospedagens já vislumbrando os momentos em que eu gostaria de conhecer mais pessoas (detalhei em outro tópico); e ainda fui pra Pouso da Cajaíba sozinha de trip (tbm detalhei em outro tópico). Cada viagem com sua vibezinha diferente e todas maravilhosas!!!
            </li>            
        </ol>
        <footer>
            <SocialLinks />
