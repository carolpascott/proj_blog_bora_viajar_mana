...
export function Pg6_Jalapao() {
  return (
    ...
    <Container>
        ...
        <p>
        Jalapão é aquela viagem dos sonhos mas que não é tão acessível assim…
        Fui pra lá qdo eu ainda estava namorando, inclusive, quase terminamos por causa dessa viagem, hahah.
        Meu ex só estudava e a mãe dele estava há uns anos afastada do trabalho. Eles decidiram viajar em pleno feriado de julho sem necessidade já que  ambos tinham disponibilidade de viajar no meio da semana como geralmente faziam. 
        ...
        <p>
        Mas, eu não ia ficar em casa sozinha em um feriado prolongado e gelado, fui pro Jalapão. Essa foi uma das decisões mais acertadas da vida! Quando levei um pé na bunda desse cara, em plena véspera da véspera de ano novo de 2020, foi uma das primeiras coisas de que me recordei. Ainda bem que não deixei de viver um sonho por causa dele.
        </p>
        <p>
        Ah, se vc leu sobre Morro de SP deve lembrar que mencionei sobre uma briga em um ano novo em MG. Não foi esse ano que terminamos. Sim, ele tinha prazer em estragar datas comemorativas. Certas coisas são livramentos em nossas vidas!!!
        </p>
        <p>
        Enfim, fechei essa viagem bem em cima da hora, como o voo estava incluso eu paguei bem caro. Jalapão foi a viagem mais cara que já fiz considerando o gasto total dividido pelos dias. Engraçado como o boy vivia falando do valor que gastei nessa viagem, como se fosse ele que pagasse meu aluguel e minha cachaça… Vocês acham que se eu tivesse desistido de ir sozinha ele iria pra lá comigo? Com certeza não. E se fosse, iria reclamar o tempo todo. 
        </p>
        <p>
        ...
        <ol>
            ...
            <li>
            Já falei que é caro, né? Maaas, normalmente todas as refeições e hospedagens estão inclusas no valor do pacote, além do transporte e entrada nos passeios. Você não vai gastar muito por lá, só com bebidas e lembrancinhas se assim quiser. Então é fácil de planejar e administrar seus gastos.
            </li>
            <li>
            Jalapão foi a primeira viagem que fiz com tantos cenários diferentes. Eu amo isso e diria que tem sido meu tipo de viagem predileta. Mas é incrível que lá essa diversidade toda está bem perto uma da outra. Outros lugares que eu fui em busca de lugares diferentes em uma única viagem foram: Rota das Emoções; Cusco, Paracas, Huacachina e Guna Yala; e Atacama e Salar de Uyuni.
            </li>            
        </ol>
        <footer>
            <SocialLinks />
